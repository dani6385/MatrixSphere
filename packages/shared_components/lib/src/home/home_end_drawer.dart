...
import 'home_end_drawer_items.dart'; // Impor data menu EndDrawer yang baru dibuat
      ...
      header: const DrawerHeader(
        ...
        child: Column(
          ...
          children: [
            ...
            Icon(
              Icons
                  .settings, // Kamu bisa mengganti ikon ini sesuai kebutuhan (misal: Icons.account_circle)
              size: 48, // Ukuran ikon
              color: Colors
