// lib/navigation/widgets/app_Report_drawer.dart

import 'package:flutter/material.dart';
import 'package:go_router/go_router.dart';
import 'package:shared_ui/shared_ui.dart';
import 'items/report_drawer_items.dart'; // Impor data menu yang sudah dipecah

class ReportDrawer extends StatelessWidget {
  const ReportDrawer({super.key});
      ...
      header: const DrawerHeader(
        ...
        child: Column(
          ...
          children: [
            ...
            Icon(
              Icons
                  .analytics, // Kamu bisa mengganti ikon ini sesuai kebutuhan (misal: Icons.account_circle)
              size: 48, // Ukuran ikon
              color: Colors
