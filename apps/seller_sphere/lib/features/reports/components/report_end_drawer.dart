...
import 'items/report_end_drawer_items.dart'; // Impor data menu EndDrawer yang baru dibuat

class ReportEndDrawer extends StatelessWidget {
  const ReportEndDrawer({super.key});
      ...
      header: const DrawerHeader(
        ...
        child: Column(
          ...
          children: [
            ...
            Icon(
              Icons
                  .filter_list, // Kamu bisa mengganti ikon ini sesuai kebutuhan (misal: Icons.account_circle)
              size: 48, // Ukuran ikon
              color: Colors
