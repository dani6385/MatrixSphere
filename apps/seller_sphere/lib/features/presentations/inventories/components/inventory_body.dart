    ...
    return StreamBuilder<List<Product>>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || snapshot.data!.isEmpty) {
          return InventoryListView(products: const [], onStockUpdateCallback: (Product product, int newStock) {  },);
        }
        return InventoryListView(products: snapshot.data!, onStockUpdateCallback: (Product product, int newStock) {  },);
      },
    );
  }
}